...
def main():
    ...
    # required arguments
    parser.add_argument('--src_dir', nargs=1, required=True,
        help='Directory containing the source to build')
    parser.add_argument('--build_dir', nargs=1, required=True,
        help='Build directory')
    parser.add_argument('--install_dir', nargs=1, required=True,
